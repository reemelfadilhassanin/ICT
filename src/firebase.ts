...
// Support optional env overrides (prefix with VITE_ for Vite clients)
...
// Export Firestore database with explicit DB ID (CRITICAL: App will break without this line)
